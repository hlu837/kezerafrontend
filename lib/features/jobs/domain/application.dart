...
class Applicant extends Equatable {
  ...
  // Employer/agency-facing "last seen" — see
  // utils/attachLastSeen.js on the backend, which merges this in from
  // User.lastActiveAt. Null if the seeker has never made an
  // authenticated request since the field was introduced.
