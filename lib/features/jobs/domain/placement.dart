...
class SuggestedSeeker extends Equatable {
  ...
  /// Only ever set when this candidate is on the *viewing* agency's
  /// own roster (see `placements.service.js#getSuggestedSeekers`'s
  /// phone-visibility check) — null for every other row, including
  /// when the viewer is an employer or a different agency.
  final String? phone;
