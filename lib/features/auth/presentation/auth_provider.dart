...
class AuthNotifier extends StateNotifier<AuthState> {
  ...
  /// Refreshes the cached user in place — used after
  /// `POST /verification/resubmit` flips a rejected account back to
  /// `pending`, so the router's verification guard (which reads
  /// `authState.user`) and VerificationStatusScreen see the new status
