          ...
          children: [
            _ReviewSection(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (city.isNotEmpty) Text(city, style: TextStyle(color: AppColors.inkMuted)),
                  if (summary.isNotEmpty) ...[
                    const SizedBox(height: 6),
                    Text(summary, style: TextStyle(color: AppColors.inkMuted, height: 1.4)),
                  ],
            ...
            _ReviewSection(
              ...
              child: experience.isEmpty
                  ? Text('None added', style: TextStyle(color: AppColors.inkFaint))
                  : Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Icon(Icons.check_circle, color: AppColors.greenDark, size: 36),
              ),
