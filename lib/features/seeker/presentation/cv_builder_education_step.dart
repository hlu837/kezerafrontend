...
class CvBuilderEducationStep extends StatelessWidget {
  ...
  String _subtitle(CvEducation e) {
    ...
    final parts = [
      ...
      if (e.gpa != null) 'GPA ${e.gpa!.toStringAsFixed(2)}',
    ];
    return parts.join(' · ');
  }
  ...
  void _save() {
    ...
    Navigator.of(context).pop(
      CvEducation(
        ...
        current: _current,
        gpa: gpaText.isEmpty ? null : double.tryParse(gpaText),
      ),
    );
  }
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (v) {
                    ...
                    if (parsed < 0 || parsed > 4) return 'Must be between 0 and 4';
                    return null;
                  },
                ),
                const SizedBox(height: 12),
