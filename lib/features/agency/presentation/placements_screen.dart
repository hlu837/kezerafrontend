      ...
      child: Column(
        ...
        children: [
          ...
          if (row.phone != null) ...[
            ...
            // Only ever populated for a candidate on this agency's own
            // roster (see `SuggestedSeeker.phone`'s doc comment) — a
            // walk-in the agency registered, so it can reach out
            // directly the moment a match shows up, without waiting on
            // Dispatch/messaging.
            CallTextButtons(phone: row.phone),
          ],
          const SizedBox(height: 8),
          Row(
            children: [
